...
window.VectorTour = (() => {
  ...
  const STATS_STEPS = [
    ...
    { el: '#tradeSummary', key: 'tour.stats.trade', side: 'bottom', align: 'end' },
    { el: '#overviewCard', key: 'tour.stats.overview', side: 'bottom', align: 'end' },
    { el: '#tradeChartsRow', key: 'tour.stats.tradeCharts', side: 'top', align: 'end' },
    { el: '#exportCard', key: 'tour.stats.exportTable', side: 'top', align: 'end' },
    { el: '#exportMoversRow', key: 'tour.stats.exportMovers', side: 'top', align: 'end' },
    { el: '#importCard', key: 'tour.stats.importTable', side: 'top', align: 'end' },
    { el: '#importMoversRow', key: 'tour.stats.importMovers', side: 'top', align: 'end' },
    { el: '#tourismCard', key: 'tour.stats.tourism', side: 'top', align: 'end' },
    { el: '#fdiCard', key: 'tour.stats.investments', side: 'top', align: 'end' },
    { el: '#fdiSectorsCard', key: 'tour.stats.fdiSectors', side: 'top', align: 'end' },
    { el: '#companiesSummary', key: 'tour.stats.companies', side: 'top', align: 'end' },
    { el: '#appendixTable', key: 'tour.stats.appendix', side: 'top', align: 'end' },
